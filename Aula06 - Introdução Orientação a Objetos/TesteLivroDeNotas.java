...
public class TesteLivroDeNotas {
    ...
    public static void main(String[] args) {
        ...
        // imprime o atributo nomeDoCurso dos dois objetos criados, utilizando o método get para ter acesso ao valor do atributo
        ...
        // atribui o novo nome do curso para o livro1 utilizando o método set
        livro1.setNomeDoCurso(novoNome);
        // exibe a mensagem de boas vindas com nome do curso atualizado
